...
$testimonial = <<<H
			<div class="col-xs-12 text-center ">
				...
				{$testimonial}
				<p class="pb"><a href="{$page_testimonial->full_url}" class="btn btn-blue-ghost">{$ctaReviewBtnText}</a></p>
			</div>
...
if ($page_url == $page_home->url) {
	...
	if (!empty($testm_arr)) {
		...
		$reviews_link = '<div class="read-reviews-wrap '.$lg_link_class.'"><a class="read-reviews btn--review" href="'.$page_testimonial->full_url.'">'.$ctaReviewHomeBtnText.'</a>
